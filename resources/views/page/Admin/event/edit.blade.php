...
@section('content')
    ...
    <section class="py-5 card info-card sales-card">
        <div class="card-body">
            ...
            <form class="row g-3" method="POST" action="{{ url('/event/' . $event->id ) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="col-md-6 m-auto">
                    <div class="my-3">
                        ...
                        <input placeholder="Masukkan Nama Event" value="{{ old('nama', $event->nama) }}" name="nama" type="text"
                            class="form-control" id="nama">
                    </div>
                    <div class="my-3">
                        <label class="form-label">Berapa Hari Pelaksanaan Event</label>
                        <input placeholder="Masukkan Lama waktu Event" value="{{ old('hari', $event->hari) }}" name="hari" type="text"
                            class="form-control" id="hari">
                    </div>
                    <div class="my-3">
                        <label for="tempat" class="form-label">Tempat</label>
                        <input placeholder="Masukkan Tempat Event" value="{{ old('location', $event->location) }}" name="location"
                    ...
                    <div class="my-3 row">
                        <div class="col-6">
                            ...
                            <select class="form-select" id="type" name="type" onchange="handleTypeChange(this)">
                                <option value="gratis">Pilih Salah Satu</option>
                                <option {{ $event->type == "gratis" ? 'selected' : '' }} value="gratis">Gratis</option>
                                <option {{ $event->type == "berbayar" ? 'selected' : '' }} value="berbayar">Berbayar</option>
                            </select>
                        </div>
                        <div class="col-6">
                            ...
                            <input readonly placeholder="Masukkan Type Event Dahulu" type="number" class="form-control"
                                id="price1" hidden value="{{ $event->harga }}">
                    ...
                    <div class="my-3">
                        ...
                        <input placeholder="Masukkan Penyelenggara Event" name="organizer" type="text"
                            class="form-control" id="penyelenggara" value='{{ old('organizer', $event['organizer']) }}'>
                        <div class="d-flex gap-2 mt-2">
                            <label for="">Level :</label>
                            <div class="form-check">
                                <input {{ $event['level'] == "universitas" ? 'checked' : '' }} type="radio" value="universitas" name="level" id="leveluniv"
                                    class="form-check-input">
                                <label for="leveluniv" form-check-label>Universitas</label>
                            </div>
                            <div class="form-check">
                                <input {{ $event['level'] == "fakultas" ? 'checked' : '' }}  type="radio" value="fakultas" name="level" id="levelfak"
                                    class="form-check-input">
                                <label for="levelfak" class="form-check-label">Fakultas</label>
                            </div>
                            <div class="form-check">
                                <input {{ $event['level'] == "prodi" ? 'checked' : '' }} type="radio" value="prodi" name="level" id="levelprod"
                                    class="form-check-input">
                                <label for="levelprod" class="form-check-label">Prodi</label>
                            </div>
                            <div class="form-check">
                                <input {{ $event['level'] == "bkm" ? 'checked' : '' }} type="radio" value="bkm" name="level" id="levelbkm"
                                    class="form-check-input">
                                <label for="levelbkm" class="form-check-label">Bkm</label>
                            </div>
                            <div class="form-check">
                                <input {{ $event['level'] == "hima" ? 'checked' : '' }} type="radio" value="hima" name="level" id="levelhim"
                                    class="form-check-input">
                                <label for="levelhim" class="form-check-label">Hima</label>
                            </div>
                            <div class="form-check">
                                <input {{ $event['level'] == "ukm" ? 'checked' : '' }} type="radio" value="ukm" name="level" id="levelukm"
                                    class="form-check-input">
                    ...
                    <div class="my-3 row">
                        <div class="col">
                            ...
                            <select class="form-select" name="status" id="status">
                                <option value="aktif">Pilih Salah Satu</option>
                                <option {{ $event['status'] == 'aktif' ? 'selected' : '' }} value="aktif">Aktif</option>
                                <option {{ $event['status'] == 'selesai' ? 'selected' : '' }} value="selesai">Selesai</option>
                            </select>
                        </div>
                        <div class="col">
                            ...
                            <select class="form-select" name="kategori" id="eventkategori">
                                <option value="aktif">Pilih Salah Satu</option>
                                <option {{ $event['kategori'] == "akademik" ? 'selected' : '' }} value="akademik">Akademik</option>
                                <option {{ $event['kategori'] == "non-akademik" ? 'selected' : '' }} value="non-akademik">Non-Akademik</option>
                            </select>
                        </div>
                        <div class="col">
                    ...
                    <div class="my-3">
                        ...
                        <div id="editor">{!! old('description', $event->description) !!}</div>
                    </div>
                    <div class="my-3">
